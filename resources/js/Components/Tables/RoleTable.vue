    ...
    <table class="table-auto responsive-spaced">
      ...
      <tr :dusk="'role-'+role.id" v-for="role in roles" :key="role.id">
        ...
        <td class="text-md">
          ...
          <button
            class="cursor-pointer text-sm inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray transition ease-in-out duration-150 cursor-pointer text-sm focus:outline-none"
