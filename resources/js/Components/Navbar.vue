        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <a href="#" class="px-3 py-2 rounded-md text-sm font-medium font-bold text-black hover:text-white hover:bg-gray-700">Home</a>

              <a href="#" class="px-3 py-2 rounded-md text-sm font-medium font-bold text-black hover:text-white hover:bg-gray-700">Booking Management</a>

              <a href="#" class="px-3 py-2 rounded-md text-sm font-medium font-bold text-black hover:text-white hover:bg-gray-700">User Management</a>

              <a href="#" class="px-3 py-2 rounded-md text-sm font-medium font-bold text-black hover:text-white hover:bg-gray-700">My Account</a>
