<template>
    <nav v-if="paginator!==undefined" class="flex items-center justify-between"
         role="navigation">
...
export default {
    ...
    methods: {
        isFirstOrLastOrDots(label) {
            return label.toString().includes('Next') || label.toString().includes('Previous') || label.toString().includes('...')
        },
    },
