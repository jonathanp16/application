        ...
        <div class="mt-10 sm:mt-0">
            <jet-action-section>
                ...
                <template #content>
                    ...
                    <jet-confirmation-modal :show="bookingRequestBeingDeleted" @close="bookingRequestBeingDeleted = null">
                        ...
                        <template #footer>
                            <jet-secondary-button @click.native="bookingRequestBeingDeleted = null">
                                Nevermind
        ...
        deleteBookingRequest() {
            this.deleteBookingRequestForm
                .delete("/bookings/" + this.bookingRequestBeingDeleted.id, {
                    preserveScroll: true,
                    preserveState: true,
                    onFinish: () => this.bookingRequestBeingDeleted = null,
                });
        },
        calendar(timestamp) {
