...
class BookingRequestControllerTest extends TestCase
{
    ...
    public function user_can_create_booking_request()
    {
        ...
        $response = $this->actingAs($user)->post('/bookings', [
            ...
            'event' => [
              'start' => $start->copy()->addHour()->format('H:i'),
              'end' => $end->copy()->subHour()->format('H:i'),
    ...
    public function booking_request_for_unavailable_room()
    {
      ...
      $response = $this->actingAs($user)->post('/bookings', [
        ...
        'reservations' => [
          [
            'start' => Carbon::parse($date)->toDateTimeString(),
            'end' => Carbon::parse($date)->addMinute->toDateTimeString(),
          ]
        ]
      ]);
